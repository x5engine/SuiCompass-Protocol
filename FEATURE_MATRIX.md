...
| | **Liquid Staking** | Interface for liquid staking derivatives (currently mocks native flow). | 🚧 **Beta** |
...
| | **Token Graph (D3)** | Interactive force-directed graph visualizing asset relationships. | 🧪 **Experimental** |
| | **Market Dashboard** | Price feeds, APY trends, and market cap visualization. | ✅ **Live** |
| **🏗️ RWA & Contracts** | **RWA Tokenization** | Form-based UI to mint Real World Assets (Real Estate, Invoices) as NFTs. | 🎨 **UI Ready** |
...
| | **CLI (sui-compass)** | Command-line interface backbone for headless interaction. | 🚧 **Foundation** |
